<?php
	...
	if ($input->get->sysop) {
		...
		$page->body .= $config->twig->render("code-tables/min/$page->codetable/list-codes.twig", ['page' => $page, 'table' => $page->codetable, 'code' => $sysop, 'sysop' => $sysop, 'optcodes' => $optcodes, 'response' => $session->response_codetable, 'recordlocker' => $recordlocker]);
		$page->body .= $config->twig->render('code-tables/edit-code-modal.twig', ['page' => $page, 'file' => "min/$page->codetable/form.twig", 'max_length_code' => SysopOptionalCode::MAX_LENGTH_CODE, 'recordlocker' => $recordlocker]);
