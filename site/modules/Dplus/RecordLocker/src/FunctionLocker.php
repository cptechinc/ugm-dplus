 ...
 */
class FunctionLocker extends WireData {
	 ...
	 * @return bool
	 */
	public function userHasRecordLocked($key) {
		return self::locker()->userHasRecordLocked($this->function, $key, $this->userid);
	}
	...
	public function lock($key) {
		return self::locker()->lock($this->function, $key, $this->userid);
	}
	...
	public function deleteLock($userID, $function, $key = false) {
		return self::locker()->deleteLock($this->$userid, $this->function, $key);
	}
